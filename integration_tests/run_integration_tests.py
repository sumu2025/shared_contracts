...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--test", type=str, help="运行特定测试 (例如: agent_model_integration)")
    parser.add_argument("-x", "--fail-fast", action="store_true", help="在第一个失败后停止")
    
    args = parser.parse_args()
    
    # 运行测试
    success = run_tests(verbose=args.verbose, test_name=args.test, fail_fast=args.fail_fast)

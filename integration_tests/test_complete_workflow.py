...
from shared_contracts.core.models.agent_models import AgentConfig, AgentStatus, AgentCapability
...
from shared_contracts.core.models.tool_models import (
    ToolDefinition, ToolResult, ToolParameter, ToolParameterType, ToolResultStatus
)
            ...
            for tool_call in tool_calls:
                ...
                if tool_response.success:
                    tool_results.append({
                        ...
                        "result": tool_response.data.data if tool_response.data.status == ToolResultStatus.SUCCESS else None,
                        "error": tool_response.data.error if tool_response.data.status == ToolResultStatus.ERROR else None
                    })

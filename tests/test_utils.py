...
class TestValidationUtils:
    ...
    def test_validate_uuid(self):
        ...
        assert validate_uuid("123e4567-e89b-12d3-a456-426655440-0") is False  # Wrong format
...
class TestVersionUtils:
    ...
    def test_is_compatible_version(self):
        ...
        assert is_compatible_version("1.2.3", min_version="1.2.0", max_version="1.3.0") is True
        assert is_compatible_version("1.2.3", min_version="1.2.3", max_version="1.3.0") is True
        assert is_compatible_version("1.2.3", min_version="1.2.4", max_version="1.3.0") is False
        assert is_compatible_version("1.2.3", min_version="1.2.0", max_version="1.2.3") is False

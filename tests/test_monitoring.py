...
from shared_contracts.monitoring.monitor_types import (
    LogLevel, ServiceComponent, EventType, MonitorEvent
)
from shared_contracts.monitoring.monitor_models import (
    MetricValue, Metric, ResourceUsage, ServiceHealthStatus,
    TraceContext, AlertConfig, AlertInstance, LogConfig
)
...
class TestMonitorModels:
    ...
    def test_log_config(self):
        ...
        config = LogConfig(
            ...
            include_components=[ServiceComponent.AGENT_CORE, ServiceComponent.API_GATEWAY],
            exclude_components=[],
...
class TestMonitorInterface:
    ...
    def test_interface_implementation(self):
        ...
        class MockMonitor:
            ...
            def record_model_validation(self, *args, **kwargs): pass
            def record_api_call(self, *args, **kwargs): pass
            def record_performance(self, *args, **kwargs): pass
            def register_metric(self, *args, **kwargs): return Metric(name="test", description="test", unit="test", metric_type="counter")
            def record_metric(self, *args, **kwargs): pass
            def get_metrics(self, *args, **kwargs): return []
            def record_health_status(self, *args, **kwargs): pass
            def get_health_status(self, *args, **kwargs): return ServiceHealthStatus(
                service_id="test", service_name="test", status="healthy", message="ok", version="1.0", uptime_seconds=0
            )
            def create_alert(self, *args, **kwargs): pass
            def update_alert(self, *args, **kwargs): pass
            def delete_alert(self, *args, **kwargs): return True
            def get_alerts(self, *args, **kwargs): return []
            def get_alert_instances(self, *args, **kwargs): return []
            def acknowledge_alert(self, *args, **kwargs): pass
            def resolve_alert(self, *args, **kwargs): pass
            def update_log_config(self, *args, **kwargs): return LogConfig(service_name="test")
            def get_log_config(self): return LogConfig(service_name="test")

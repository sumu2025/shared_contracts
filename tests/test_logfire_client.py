...
from shared_contracts.monitoring.monitor_types import LogLevel, ServiceComponent, EventType
...
class TestMonitorUtils:
    ...
    def setup_monitor(self):
        ...
        with patch("shared_contracts.monitoring.utils.logger_utils.get_monitor") as mock_get_monitor:
            # Create mock monitor
    ...
    def test_track_performance(self, setup_monitor):
        ...
        assert mock_monitor.record_performance.call_args[1]["operation"] == "test-operation"
        assert mock_monitor.record_performance.call_args[1]["component"] == ServiceComponent.AGENT_CORE
    ...
    def test_track_performance_exception(self, setup_monitor):
        ...
        with pytest.raises(ValueError):
            with track_performance("error-operation", ServiceComponent.AGENT_CORE) as span:
    ...
    def test_with_monitoring_decorator(self, setup_monitor):
        ...
        assert mock_monitor.start_span.call_args[1]["component"] == ServiceComponent.AGENT_CORE
        ...
        # Check that performance was recorded
        mock_monitor.record_performance.assert_called_once()
        assert mock_monitor.record_performance.call_args[1]["operation"] == "test_function"
        assert mock_monitor.record_performance.call_args[1]["success"] is True
    ...
    def test_nested_traces(self, setup_monitor):
        ...
        with create_trace_context("outer", ServiceComponent.AGENT_CORE) as outer_span:
            ...
            with create_trace_context("inner", ServiceComponent.AGENT_CORE) as inner_span:
        ...
        assert mock_monitor.end_span.call_args_list[0][0][0] == span_instances[1]  # inner
        assert mock_monitor.end_span.call_args_list[1][0][0] == span_instances[0]  # outer

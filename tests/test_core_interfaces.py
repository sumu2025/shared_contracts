...
import uuid
import pytest
from typing import Dict, List, Any, Optional, Protocol, AsyncIterable, runtime_checkable
...
from shared_contracts.core.interfaces.common_errors import (
    ServiceError, NotFoundError, ValidationError, AuthenticationError
)
from shared_contracts.core.models.base_models import BaseResponse
from shared_contracts.core.models.agent_models import AgentConfig, AgentState, AgentStatus, AgentCapability
...
from shared_contracts.core.models.tool_models import (
    ToolDefinition, ToolResult, ToolParameters, ToolParameter, 
    ToolParameterType, ToolResultStatus
)
...
class TestServiceInterfaces:
    ...
    async def test_agent_service_interface_implementation(self):
        ...
        class ConcreteAgentService:
            ...
            async def get_agent_state(self, agent_id: uuid.UUID) -> BaseResponse[AgentState]:
            ...
            async def send_message_to_agent(
                self, agent_id: uuid.UUID, message: str, conversation_id: Optional[uuid.UUID] = None
    ...
    async def test_tool_service_interface_implementation(self):
        ...
        class ConcreteToolService:
            async def register_tool(self, definition: ToolDefinition) -> BaseResponse[ToolDefinition]:
                return BaseResponse(
                    request_id=uuid.uuid4(),
                    success=True,
                    data=definition

...
def deep_dict_update(
    ...
    for key, value in update_dict.items():
        ...
        elif key in result and isinstance(result[key], list) and isinstance(value, list) and not overwrite_lists:
            # Extend lists
...
def bytes_to_data(
    ...
    try:
        ...
        try:
            ...
            raise ValueError(f"Could not convert bytes to {target_type.__name__}: {str(e)}")

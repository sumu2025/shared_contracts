...
def validation_tools_example():
    ...
    # 字符串长度验证
    print(f"字符串长度验证 (3-10): {validate_string_length('test', min_length=3, max_length=10)}")
    print(f"字符串长度验证 (太短): {validate_string_length('ab', min_length=3, max_length=10)}")
    print(f"字符串长度验证 (太长): {validate_string_length('very long string', min_length=3, max_length=10)}")

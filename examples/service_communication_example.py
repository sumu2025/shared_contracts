        ...
        async def handle_request(message: Any) -> None:
            ...
            if action == "create_agent":
                ...
                await self.message_queue.push(
                    f"response_{request_id}", serialized_result
                )
    ...
    async def send_message_to_agent(
        ...
        try:
            ...
            return BaseResponse(
                request_id=uuid.uuid4(),
                success=True,
                data={"response": response, "conversation_id": str(uuid.uuid4())},
            )
...
async def http_communication_example() -> None:
    ...
    try:
        ...
        if create_result.get("success"):
            ...
            message_result = await agent_client.send_message(agent_id, "Hello, agent!")

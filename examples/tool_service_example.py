    ...
    async def execute_tool(
        ...
        try:
            ...
            if tool_id in self.tool_executors:
                with track_performance(f"tool_execution_{tool_id}", ServiceComponent.TOOL_SERVICE) as span:
...
async def run_example():
    ...
    if translator_result.success:
        ...
        async def execute_translator(parameters: Dict[str, Any]) -> Dict[str, Any]:
            ...
            # 查找翻译或返回原文
            translation = translations.get((source_lang, target_lang, text.lower()), f"[{text}]")
